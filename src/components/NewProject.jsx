...
const NewProject = ({ onAdd, onCancel }) => {
  ...
  return (
    ...
    <div className="w-[35rem] mt-16">
      ...
      <menu className="flex items-center justify-end gap-4 my-4 max-md:justify-center">
        <li>
          <button onClick={onCancel}  className="text-stone-700 hover:text-stone-950">Cancel</button>
        </li>
        <li>
        <button className="px-6 py-2 bg-stone-700 text-stone-50 hover:bg-stone-950 rounded-md max-md:px-4 max-md:py-1"
